...
- Name: flujo2-operacion-diaria.spec.ts >> Flujo 2 — Gestión de pedidos >> botón volver regresa a la lista de pedidos
- Location: e2e\flujo2-operacion-diaria.spec.ts:76:7
