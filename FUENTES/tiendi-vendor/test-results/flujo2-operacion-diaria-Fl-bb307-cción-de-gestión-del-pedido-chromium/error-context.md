...
- Name: flujo2-operacion-diaria.spec.ts >> Flujo 2 — Gestión de pedidos >> página de detalle muestra sección de gestión del pedido
- Location: e2e\flujo2-operacion-diaria.spec.ts:46:7
