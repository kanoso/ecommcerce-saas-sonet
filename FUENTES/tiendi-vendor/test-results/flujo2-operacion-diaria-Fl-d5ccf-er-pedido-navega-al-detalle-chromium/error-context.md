...
- Name: flujo2-operacion-diaria.spec.ts >> Flujo 2 — Gestión de pedidos >> click en primer pedido navega al detalle
- Location: e2e\flujo2-operacion-diaria.spec.ts:31:7
