...
- Name: flujo2-operacion-diaria.spec.ts >> Flujo 2 — Gestión de pedidos >> navegar a /vendor/orders muestra lista de pedidos
- Location: e2e\flujo2-operacion-diaria.spec.ts:19:7
